...
class Department(models.Model):
    department_id = models.UUIDField(primary_key=True, max_length=15)
...
class Teams(models.Model):
    team_id = models.UUIDField(primary_key=True, max_length=15)
...
class Users(models.Model):
    user_id = models.UUIDField(primary_key=True, max_length=12)
...
class Objectives(models.Model):
    objective_id = models.UUIDField(primary_key=True, max_length=12)
...
class Keyresults(models.Model):
    keyresult_id = models.UUIDField(primary_key=True, max_length=12)
